...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "FRTAG_W" -parent ${Page_0}
...
proc update_PARAM_VALUE.FRTAG_W { PARAM_VALUE.FRTAG_W } {
	# Procedure called to update FRTAG_W when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.FRTAG_W { PARAM_VALUE.FRTAG_W } {
	# Procedure called to validate FRTAG_W
	return true
}
...
proc update_MODELPARAM_VALUE.FRTAG_W { MODELPARAM_VALUE.FRTAG_W PARAM_VALUE.FRTAG_W } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.FRTAG_W}] ${MODELPARAM_VALUE.FRTAG_W}
}
