...
HD_PWD=/home/jara/ownCloud-pluto/elektronika/etherlink-hdl/vivado_ip/eth100_link_tx/eth100_link_tx/eth100_link_tx.runs/synth_1
cd "$HD_PWD"
...
EAStep vivado -log iptop_eth100_link_tx.vds -m64 -mode batch -messageDb vivado.pb -notrace -source iptop_eth100_link_tx.tcl
