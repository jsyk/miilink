...
long lSerialPutStringN( long lPort, const char * const pcString, unsigned long ulStringLength )
{
long lReturn;
unsigned long ul;
...
long lSerialPutString( long lPort, const char * const pcString)
{
    return lSerialPutStringN(lPort, pcString, strlen(pcString));
}
