...
CONFIG.CONST_VAL {0} \
  ...
  connect_bd_net -net rmii_crs_dv_1 [get_bd_ports rmii_crs_dv] [get_bd_pins eth100_loopback_rxtx_0/rmii_rxdv]
  connect_bd_net -net rmii_rxd_1 [get_bd_ports rmii_rxd] [get_bd_pins eth100_loopback_rxtx_0/rmii_rxdt]
