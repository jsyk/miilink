...
architecture rtl of rxlink_cbuf_ctrl is
    ...
    type registers_t is record
        bottom : wordpointer_t;
        top : wordpointer_t;
        wptr : wordpointer_t;
        subptr : bytepointer_t;
        frlength : wordpointer_t;
        wptr_at_end : std_logic;
    
        b_overflowed : std_logic;         -- buffer enque has caused overflow (must cancel buffer and discard frame)
        -- m_addr      : std_logic_vector(MEM_ADDR_W-1 downto 0);
        m_wdt       : std_logic_vector(31 downto 0);
        m_wstrobe   : std_logic;
        pf_enq      : std_logic;
        -- pf_frlen    : std_logic_vector(8 downto 0);
        -- rf_deq      : std_logic;
    end record;
