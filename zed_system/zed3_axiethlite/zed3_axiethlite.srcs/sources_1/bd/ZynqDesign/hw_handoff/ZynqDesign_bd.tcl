...
CONFIG.CONST_VAL {0} \
  ...
  connect_bd_intf_net -intf_net ps7_axi_periph_M04_AXI [get_bd_intf_pins axi_bram_ctrl_0/S_AXI] [get_bd_intf_pins ps7_axi_periph/M04_AXI]

  # Create port connections
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins mii_to_rmii_0/ref_clk]
  ...
  create_bd_addr_seg -range 0x2000 -offset 0x40000000 [get_bd_addr_spaces ps7/Data] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] SEG_axi_bram_ctrl_0_Mem0
...
preplace inst mii_to_rmii_0 -pg 1 -lvl 5 -y 470 -defaultsOSRD
preplace inst ps7_axi_periph -pg 1 -lvl 3 -y -160 -defaultsOSRD
preplace inst clk_wiz_0 -pg 1 -lvl 5 -y 730 -defaultsOSRD
preplace inst ethernetlite_0 -pg 1 -lvl 4 -y 550 -defaultsOSRD
preplace inst gpio_btns -pg 1 -lvl 4 -y 200 -defaultsOSRD
preplace inst axi_bram_ctrl_0 -pg 1 -lvl 4 -y 870 -defaultsOSRD
...
preplace netloc ps7_axi_periph_M02_AXI 1 3 1 1210
preplace netloc mii_to_rmii_0_rmii2phy_tx_en 1 5 1 1820
preplace netloc processing_system7_0_axi_periph_M00_AXI 1 3 1 1240
preplace netloc processing_system7_0_M_AXI_GP0 1 1 2 NJ -300 N
preplace netloc rmii_crs_dv_1 1 5 1 1820
preplace netloc processing_system7_0_FCLK_RESET0_N 1 1 1 200
preplace netloc ethernetlite_0_phy_rst_n 1 4 1 1540
preplace netloc ps7_FCLK_CLK1 1 1 5 NJ -390 NJ -390 NJ -390 NJ 320 NJ
preplace netloc rst_processing_system7_0_100M_peripheral_aresetn 1 2 2 580 -360 1200
preplace netloc ps7_axi_periph_M01_AXI 1 3 1 1230
preplace netloc mii_to_rmii_0_rmii2phy_txd 1 5 1 1810
preplace netloc xlconstant_0_dout 1 5 1 1800
...
preplace netloc clk_wiz_0_clk_out1 1 4 2 1550 570 1790
preplace netloc rmii_rxd_1 1 5 1 1820
preplace netloc axi_gpio_0_GPIO 1 4 2 NJ -160 N
preplace netloc ethernetlite_0_MII 1 4 1 1520
preplace netloc ps7_axi_periph_M04_AXI 1 3 1 1180
preplace netloc rst_ps7_100M_bus_struct_reset 1 2 3 NJ -380 NJ -380 1510
preplace netloc processing_system7_0_FCLK_CLK0 1 0 4 -210 -110 220 -210 590 -370 1220
preplace netloc rst_processing_system7_0_100M_interconnect_aresetn 1 2 1 570
preplace netloc ps7_axi_periph_M03_AXI 1 3 1 1190
levelinfo -pg 1 -230 -10 390 1030 1380 1670 1840 -top -420 -bot 940
",
}
